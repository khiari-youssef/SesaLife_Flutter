                  ...
                  children: [
                    AnimatedContainer(
                        ...
                        child: CreditCardPreview(
                          ...
                          cardExpirationDateController: cardExpiryController,
                        )),
                    16.verticalSpace,
                    SesamePasswordTextField(
                        keyboardType: TextInputType.text,
                        controller: cardHolderNameController,
                        placeHolder: S.of(context).payment_card_holder_name,
                    ...
                    Row(children: [
                      Flexible(
                          child: SesamePasswordTextField(
                              ...
                              label: S.of(context).payment_card_expiry_date)),
                      16.horizontalSpace,
                      Flexible(
                          child: SesamePasswordTextField(
                              keyboardType: TextInputType.number,
                              ...
                              placeHolder:
                                  S.of(context).payment_card_cvv_placeholer,
                              onChange: (cvv) {
                                setState(() {
